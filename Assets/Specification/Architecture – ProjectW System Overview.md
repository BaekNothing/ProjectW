...
| **동기화 시각 (UTC)** | `2026-06-20T13:08:40Z` |
| **기준 커밋 (전체 SHA)** | `ebc628bdcb1f985ebd0fb00cb8a612d9ccb367dd` |
| **기준 커밋 (단축)** | `ebc628b` |
| **브랜치** | `ai-integration` |
| **추적 경로 지문** | `sha256:a9ae32e5892198e14a3ada86a91e4d69733b38c2268d6367b7dd3a9cf99b6bf1` |
...
| Panel frame resource | `Assets/Resources/CaseReviewData/UI/Panel_Background_Frame.jpg`를 Sprite 9-slice(`spriteBorder` 140 px)로 import하고, `pixelsPerUnitMultiplier = 5`로 검정 테두리가 얇게 보이도록 surface panel `Image.Type.Sliced` 배경에 적용 |
...
- `PanelFrameResourcePath = CaseReviewData/UI/Panel_Background_Frame`을 `Resources.Load<Sprite>`로 읽고, button/blocker/icon/handle을 제외한 surface panel에는 `Image.Type.Sliced`와 `PanelFramePixelsPerUnitMultiplier = 5`로 얇은 hand-drawn frame 배경을 적용한다.
