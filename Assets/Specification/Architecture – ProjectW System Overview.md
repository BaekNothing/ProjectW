...
| **동기화 시각 (UTC)** | `2026-06-05T06:08:07Z` |
| **기준 커밋 (전체 SHA)** | `eddc00b6a68ba4f63c355e880eed24a6b6960ed0` |
| **기준 커밋 (단축)** | `eddc00b` |
| **브랜치** | `ai-integration` |
| **추적 경로 지문** | `sha256:72d7d42d054d7180365605b0b170f60ddfad13bafbfd38e1396633746743e06d` |
