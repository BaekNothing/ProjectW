...
| **동기화 시각 (UTC)** | `2026-06-03T17:52:14Z` |
| **기준 커밋 (전체 SHA)** | `e8d5e092e3ee6d178b8dd910df44004e4721a2ba` |
| **기준 커밋 (단축)** | `e8d5e09` |
| **브랜치** | `ai-integration` |
| **추적 경로 지문** | `sha256:bbf0e55a5299127044c0ba6e79b6e5b688f26ba75ba339b5c27c69adc625e302` |
