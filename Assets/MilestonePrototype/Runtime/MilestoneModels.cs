...
namespace ProjectW.MilestonePrototype
{
    ...
    public sealed class TaskSystemBalance
    {
        ...
        public int MatchingFatigue = 4;
        public int MismatchedFatigue = 7;
        public int ParallelFatigue = 5;
        public int SoftDeadlineFatigue = 4;
        public int RestRecovery = 9;
        public int WeekendFatigueRecovery = 9;
        public int WeekendMentalRecovery = 8;
        public int WeekendInjuryRecoveryChance = 35;
        public int FirstRegularCheckupDay = 61;
        public int RegularCheckupIntervalDays = 56;
