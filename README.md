...
| Script Presentation scenario events | Data assets, localization interfaces, scenario data workshop, CSV import/export, and Google Sheets full-snapshot replacement implemented for text, work, cards, characters, and scenarios |
